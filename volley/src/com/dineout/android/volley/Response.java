...
public class Response<T> {
	...
	public interface Listener<T> {
		...
		public void onResponse(Request<T> request, T responseObject,
				Response<T> response);
	}
	...
	protected void setStartTimeInMillis(long startTimeInMillis) {
		this.startTimeInMillis = startTimeInMillis;
	}

	protected void setEndTimeInMillis(long endTimeInMillis) {
	...
	public void setNetworkRequestSent(boolean networkRequestSent) {
		this.networkRequestSent = networkRequestSent;
	}
