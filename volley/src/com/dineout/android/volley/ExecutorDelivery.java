...
public class ExecutorDelivery implements ResponseDelivery {
	...
	private class ResponseDeliveryRunnable implements Runnable {
		...
		@Override
		public void run() {
			mResponse.setEndTimeInMillis(System.currentTimeMillis());
			...
			if (mResponse.isSuccess()) {
				if(globalRequestQueueListener!=null) {
					globalRequestQueueListener.onResponse(mRequest, mResponse.result,mResponse);
				}
				mRequest.deliverResponse(mRequest, mResponse.result, mResponse);
			} else {
				mRequest.deliverError(mRequest, mResponse.error);
			}
