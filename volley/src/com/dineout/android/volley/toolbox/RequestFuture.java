...
public class RequestFuture<T>
	...
	@Override
	public synchronized void onResponse(Request<T> request, T response,
			Response<T> fullResponse) {
		mResultReceived = true;
		mResult = response;
		mResponse = fullResponse;
		notifyAll();
	}

	@Override
	public synchronized void
			onErrorResponse(Request request, VolleyError error) {
		mException = error;
		notifyAll();
	}
}
