...
import com.dineout.android.volley.Cache.Entry;
...
import com.dineout.android.volley.NoConnectionError;
import com.dineout.android.volley.Request;
import com.dineout.android.volley.RetryPolicy;
import com.dineout.android.volley.ServerError;
...
//							responseHeaders, true);
				...
				if (responseContents != null) {
					networkResponse = new NetworkResponse(statusCode,
							responseContents,responseHeaders, false, SystemClock.elapsedRealtime() - requestStart);
	...
	private void logSlowRequests(long requestLifetime, Request<?> request,
		...
		if (DEBUG || requestLifetime > SLOW_REQUEST_THRESHOLD_MS) {
			VolleyLog.d(
					...
					requestLifetime, responseContents != null
							? responseContents.length
							: "null", statusLine.getStatusCode(), request
	...
	private void
			addCacheHeaders(Map<String, String> headers, Cache.Entry entry) {
