...
class UploadNotificationConfig implements Parcelable {
    ...
    public UploadNotificationConfig(final int iconResourceID, final String title, final String message, final String completed, final String error, final boolean autoClearOnSuccess)
